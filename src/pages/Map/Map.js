...
export default class Map extends Component {
    ...
    componentDidMount() {
        ...
        var point = new BMap.Point(120.4803609457,32.5278783490);
        var title = '江苏省海安市华新年年有鱼大酒店';
        ...
        map.setCurrentCity("海安");          // 设置地图显示的城市 此项是必须设置的
        ...
        /*信息框*/
        var infoWindow = new BMapLib.SearchInfoWindow(map, "2018年10月20日18:00恭候各位光临", {
            title: title, //标题
            width: 130, //宽度
            height: 20, //高度
            panel: "panel", //检索结果面板
